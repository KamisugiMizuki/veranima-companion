...
| JSON 键 | 说明 |
|---|---|
| `initial_affection` | 初始好感（2026-08 新增，注入 `【初始好感】`）：对用户的初始好感与性吸引力基调——亲近/偏爱/暧昧底色、可开性暗示玩笑、亲昵称呼、占有欲与吃醋；亲密程度随依恋度加深 |
| `body_setting` | 身体设定（虚构框架内）：体质/身体特征的特殊设定，如性兴奋时的身体变化、自慰习惯动作 |
